# ============================================================
# FILE: pipeline/step04_evaluator.py
# CHỨC NĂNG: Controller — Đánh giá mô hình trên tập Test tổng hợp
# Logic data nằm trong: data/dataset.py
# Logic metrics nằm trong: core/metrics/segmentation.py
# ============================================================
...
from medical_pipeline.core.metrics.segmentation import calculate_dice, calculate_iou, calculate_pixel_accuracy
from medical_pipeline.core.models.losses import hybrid_loss, student_distill_loss
from medical_pipeline.data_modules.dataset import get_file_lists


def evaluate_test_set(model_path=None):
    """Đánh giá model trên toàn bộ tập test, lưu báo cáo JSON."""
    ...
    p_img, p_a, p_b, p_c = get_file_lists(DATASET_DIR, "test")
    if not p_img:
